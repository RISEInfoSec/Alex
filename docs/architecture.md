...
| 3 | Quality gate    | `alex.cli score`          | `discovery_candidates.csv`     | `quality_metrics.csv`, `accepted_candidates.csv`, `review_queue.csv`, `rejected_candidates.csv` | Auto-include ≥75 / review 45–74.99 / reject <45 (peer-reviewed). Preprints have a separate ladder. |
